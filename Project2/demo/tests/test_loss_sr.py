...
"""
Usage: ./test_loss_sr.py output_file or python3 test_loss_sr.py output_file
"""
...
def check_timeout(all_lines) -> bool:
    ...
    for lino, line in enumerate(all_lines):
        ...
        if is_timeout and resend_counter < 1:
        ...
        if not is_timeout:
            if result['event'] == 'RESEND':
                print('[Warning] excessive retransmission at line #', lino+1)
